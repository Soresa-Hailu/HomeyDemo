...
@Component({
  selector: 'app-satellite-ethiopia',
  templateUrl: './satellite-ethiopia.component.html',
  styleUrls: ['./satellite-ethiopia.component.scss']
})
export class SatelliteEthiopiaComponent implements OnInit {
