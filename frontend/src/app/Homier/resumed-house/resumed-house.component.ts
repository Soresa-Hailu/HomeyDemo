...
@Component({
  selector: 'app-resumed-house',
  templateUrl: './resumed-house.component.html',
  styleUrls: ['./resumed-house.component.scss']
})
export class ResumedHouseComponent implements OnInit {
  constructor(
      ...
      this.http.post(this.commonService.base_url + `/house/markAsAccepted/${id}`, { status } )
        .subscribe(result => {
          ...
          if (data && data.nModified == 1) {
            ...
            this.router.navigate([`/homier/posted-house`]);
          }
